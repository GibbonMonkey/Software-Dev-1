...
//Scanners for all 3 questions
    ...
    //What I learned: I learned how to properly check if string variables match, and how to
    // Add up values using a single variable which in this case was the score counter.
